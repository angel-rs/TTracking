...
export default {
  ...
  checkboxBgColor: Colors.tintColor,
  checkboxSize: 20,
  checkboxTickColor: "#fff",

  // Color
  brandPrimary: Colors.tintColor,
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: Colors.tintColor,
  ...
  tabActiveBgColor: Colors.tintColor,

  // Header
  toolbarBtnColor: platform === "ios" ? "#007aff" : "#fff",
  toolbarDefaultBg: Colors.tintColor,
  ...
  toolbarDefaultBorder: Colors.tintColor,
  get statusBarColor() {
  ...
  radioSelectedColorAndroid: Colors.tintColor,
